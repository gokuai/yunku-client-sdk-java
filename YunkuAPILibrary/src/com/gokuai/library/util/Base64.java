...
public class Base64 {
	...
	public static String encodeObject(java.io.Serializable serializableObject, int options) throws java.io.IOException {
		...
		try {
			// ObjectOutputStream -> (GZIP) -> com.gokuai.util.Base64 -> ByteArrayOutputStream
	...
	public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws java.io.IOException {
		...
		if ((options & GZIP) != 0) {
			...
			try {
				// GZip -> com.gokuai.util.Base64 -> ByteArray
				baos = new java.io.ByteArrayOutputStream();
				b64os = new OutputStream(baos, ENCODE | options);
				gzos = new java.util.zip.GZIPOutputStream(b64os);
		...
		// Else, don't compress. Better not to use streams at all then.
			...
			// int len43 = len * 4 / 3;
			// byte[] outBuff = new byte[ ( len43 ) // com.gokuai.Main 4:3
	...
	public static byte[] decode(byte[] source, int off, int len, int options) throws java.io.IOException {
		...
		if (len == 0) {
			...
			throw new IllegalArgumentException("com.gokuai.util.Base64-encoded string must have at least four characters, but length specified was " + len);
		} // end if
		...
		for (i = off; i < off + len; i++) { // Loop through source
			...
			// White space, Equals sign, or legit com.gokuai.util.Base64 character
			...
			if (sbiDecode >= WHITE_SPACE_ENC) {
				...
				// There's a bad input character in the com.gokuai.util.Base64 stream.
				throw new java.io.IOException(String.format("Bad com.gokuai.util.Base64 input character decimal %d in array position %d", source[i] & 0xFF, i));
			} // end else:
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		public int read() throws java.io.IOException {
			...
			if (position < 0) {
				...
				// Else decoding
					...
					if (i == 4) {
						...
						throw new java.io.IOException("Improperly padded com.gokuai.util.Base64 input.");
					} // end
			...
			// Else error
				...
				throw new java.io.IOException("Error in com.gokuai.util.Base64 code reading stream.");
			} // end else
		} // end read
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		public void write(int theByte) throws java.io.IOException {
			...
			// Else, Decoding
				...
				// Meaningful com.gokuai.util.Base64 character?
				if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
					...
					throw new java.io.IOException("Invalid character in com.gokuai.util.Base64 data.");
		...
		public void flushBase64() throws java.io.IOException {
			if (position > 0) {
				if (encode) {
					...
					throw new java.io.IOException("com.gokuai.util.Base64 input not properly padded.");
				} // end else: decoding
